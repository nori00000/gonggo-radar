...
class GafiCrawler(BaseCrawler):
    """경기도농수산진흥원(gafi.or.kr) 공고 게시판 크롤러.

    대상 URL:
        - https://www.gafi.or.kr/web/board/boardContentsListPage.do?board_id=42&menu_id=...
    ...
    def __init__(self):
        super().__init__(source_name="gafi")
    ...
    def _parse_generic_links(self, soup: "BeautifulSoup") -> List[dict]:
        ...
        view_patterns = [
            re.compile(r"boardContentsView", re.I),
            re.compile(r"view\.do", re.I),
            re.compile(r"contents_id=", re.I),
    ...
    def _extract_post_id(self, link: str) -> str:
        ...
        id_params = [
            r"contents_id=(\w+)", r"announcementId=(\d+)", r"notifyId=(\d+)",
