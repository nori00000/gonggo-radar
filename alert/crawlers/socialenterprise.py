...
class SocialenterpriseCrawler(BaseCrawler):
    """한국사회적기업진흥원(socialenterprise.or.kr) 공고 게시판 크롤러.

    대상 URL:
        - https://www.socialenterprise.or.kr (홈페이지 기반 링크 추출)

    HTML 파싱 방식:
        BOARD_PATHS가 비어있으므로 홈페이지 URL에서 범용 링크 추출을 시도한다.
    """
