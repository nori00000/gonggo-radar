...
class AgrohealingCrawler(BaseCrawler):
    ...
    def fetch(self) -> List[RawAnnouncement]:
        ...
        for board_path in self.BOARD_PATHS:
            ...
            self.logger.info(f"Fetching from Agrohealing announcement board: {url}")
