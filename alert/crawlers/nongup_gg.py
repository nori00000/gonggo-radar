...
class NongupGgCrawler(BaseCrawler):
    """경기도농업기술원(nongup.gg.go.kr) 공고 게시판 크롤러.

    대상 URL:
        - https://nongup.gg.go.kr/noti/35
    ...
    def __init__(self):
        super().__init__(source_name="nongup_gg")
    ...
    def fetch(self) -> List[RawAnnouncement]:
        ...
        for board_path in self.BOARD_PATHS:
            ...
            self.logger.info(f"Fetching from NongupGg board: {url}")
