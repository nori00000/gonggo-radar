...
class EkrCrawler(BaseCrawler):
    """한국농어촌공사(ekr.or.kr) 입찰공지사항 크롤러.

    대상 URL:
        - https://www.ekr.or.kr/index.krc?contentUid=402880317cc0644a017cc0c22f2800f0
    ...
    BOARD_PATHS = ["/index.krc?contentUid=402880317cc0644a017cc0c22f2800f0"]

    def __init__(self):
        super().__init__(source_name="ekr")
    ...
    def fetch(self) -> List[RawAnnouncement]:
        ...
        for board_path in self.BOARD_PATHS:
            ...
            self.logger.info(f"Fetching from EKR announcement board: {url}")
    ...
    def _parse_generic_links(self, soup: "BeautifulSoup") -> List[dict]:
        ...
        view_patterns = [
            re.compile(r"index\.krc", re.I),
            re.compile(r"contentUid=", re.I),
    ...
    def _extract_post_id(self, link: str) -> str:
        ...
        id_params = [
            r"contentUid=(\w+)", r"announcementId=(\d+)", r"notifyId=(\d+)",
