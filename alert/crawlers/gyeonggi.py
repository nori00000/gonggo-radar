...
class GyeonggiCrawler(BaseCrawler):
    ...
    BOARD_PATHS = ["/bbs/board.do?bsIdx=469&menuId=1547"]

    def __init__(self):
        super().__init__(source_name="gyeonggi")
    ...
    def fetch(self) -> List[RawAnnouncement]:
        ...
        for board_path in self.BOARD_PATHS:
            ...
            self.logger.info(f"Fetching from Gyeonggi announcement board: {url}")
