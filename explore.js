...
(async () => {
  ...
  fs.writeFileSync('/Users/leesangmin/agrion-automation/page_dump.html', html);
  ...
  fs.writeFileSync('/Users/leesangmin/agrion-automation/form_info.json',
  ...
  // Take screenshots
  await page.screenshot({ path: '/Users/leesangmin/agrion-automation/page_screenshot.png', fullPage: true });
  console.log('\n스크린샷 저장 완료');
